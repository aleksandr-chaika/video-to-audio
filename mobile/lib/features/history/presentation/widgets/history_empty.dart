...
/// waveform-полосой сверху и mic-icon в центре. Подаём целиком как
/// Image.asset, ниже — центрированные тексты.
class HistoryEmptyView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      // SizedBox(width:infinity) даёт Column ширину родителя — иначе
      // crossAxisAlignment.center не сработает (в HomePage Column использует
      // crossAxisAlignment.start, и без растяжения наш Column был бы узким).
      child: SizedBox(
